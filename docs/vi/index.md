...
| # | Phần | ⏱️ | Mô tả |
|---|------|-----|-------|
| 1 | [Tạo tài khoản GitHub](01-create-github-account.md) | 5 phút | Đăng ký GitHub Free, xác thực email |
| 2 | [Tạo Repository mới (Private)](02-create-repository.md) | 3 phút | Tạo repo private trên GitHub |
| 3 | [Cấu hình .devcontainer cho Codespace](03-setup-devcontainer.md) | 5 phút | Tạo config chuẩn với 3 file |
...
- [Thiết lập Git & GitHub trên máy local](appendix-local-git-setup.md)
